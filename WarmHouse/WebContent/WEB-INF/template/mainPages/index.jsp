...
<head>
    ...
    <div id="main">
       <!-- 顶部导航栏 -->
       <div class="title-nav">
           <div class="userinfo" onclick="showUserMenu(event)">
               ...
               <div class="welcome-tip"
                    style="position: absolute; left: 180px; right: 0; top: 50%; transform: translateY(-50%); padding: 0 20px; font-size: 24px; font-weight: bold; color: #2c3e50; letter-spacing: 2px; text-align: center; white-space: nowrap; overflow: hidden; line-height: 1;">
                    欢迎来到智能房源管理系统！
               </div>
           </div>
           <div class="user-menu">
        		<span class="triangle"></span>
               	...
               	<div><a href="${pageContext.request.contextPath}/user/history" target="content-box">浏览记录</a></div>
               	<div><a href="${pageContext.request.contextPath}/user/favorites" target="content-box">我的收藏</a></div>
       ...
       <div class="edit-space">
           <div class="content">
           		<iframe name="content-box" src="welcome" width="100%" height="100%" frameborder="0" scrolling="auto"></iframe>
           </div>
       </div>
    </div>
