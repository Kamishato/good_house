	...
	<div class="user-manage">
	    <div class="searchUser">
	    	<form class="listuser" action="${basePath}/information/infotb" method="post" target="userTableList">
    			...
    			<!-- 普通用户仅展示自己的房源：保留隐藏 username，用于后端过滤 -->
	    		...
	    		<input type="number" id="suiteBathroom" name="suiteBathroom" min="0" class="getsuiteBathroom">卫
	    		
	    		<span>面积：</span>
				<input type="number" id="area" name="area" min="0.0" class="getArea" step="0.01">㎡
				...
				<span>建造年份：</span>
				<input type="number" id="birth" name="birth" min="0" max="2022" class="getBirth">年
				...
				<span>租金：</span>
				<input type="number" id="price" name="price" min="0.0" class="getPrice" step="0.01">元/月
