    ...
    <script>
	    ...
	    page.init({
	        ...
	        callback: function(pageNum, pageSize, totals) {
	            var p = window.parent;
	            var flagEl = p.document.getElementById('searchInformationFlag');
	            if (flagEl) flagEl.value = '1';
	            p.document.querySelector('.pageNum').value = pageNum;
	            p.document.querySelector('.pageSize').value = pageSize;
	            p.document.querySelector('.form').submit();
	        },
