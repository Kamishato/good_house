...
public class HouseInformation extends IdEntity {
	...
	public String getRentalReqs() {
		return rentalReqs;
	}
	public void setRentalReqs(String rentalReqs) {
		this.rentalReqs = rentalReqs;
	}
	...
	public String toString() {
		return "HouseInformation [code=" + code + ", title=" + title + ", suiteRoom=" + suiteRoom + ", suiteHall="
				...
				+ ", detailedAddress=" + detailedAddress + ", contactWechat=" + contactWechat + ", highlights="
				+ highlights + ", rentalReqs=" + rentalReqs + ", description=" + description + "]";
	}
